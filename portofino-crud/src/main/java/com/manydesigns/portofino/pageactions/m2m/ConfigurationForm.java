...
public class ConfigurationForm extends ManyToManyConfiguration {
	...
	public ConfigurationForm(ManyToManyConfiguration m2mConfiguration) {
		...
		if (m2mConfiguration.getOneSelectionProvider() != null && m2mConfiguration.getOneSelectionProvider().getActualSelectionProvider() != null) {
			oneSpName = m2mConfiguration.getOneSelectionProvider().getActualSelectionProvider().getName();
		}
		if (m2mConfiguration.getManySelectionProvider() != null && m2mConfiguration.getManySelectionProvider().getActualSelectionProvider() != null) {
