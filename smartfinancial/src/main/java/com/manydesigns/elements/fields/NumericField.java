...
public class NumericField extends AbstractTextField {
	...
	public NumericField(PropertyAccessor accessor, Mode mode, String prefix) {
		...
		if (accessor.isAnnotationPresent(PrecisionScale.class)) {
			...
			BigInteger unscaledMaxValue = BigInteger.TEN.pow(precision).subtract(BigInteger.ONE);
		...
		com.manydesigns.elements.annotations.DecimalFormat decimalFormatAnnotation = accessor.getAnnotation(com.manydesigns.elements.annotations.DecimalFormat.class);
	...
	public void readFromRequest(HttpServletRequest req) {
		...
		try {
			...
			tmpValue = (BigDecimal) OgnlUtils.convertValue(stringValue, BigDecimal.class);
		} catch (Throwable e) {
	...
	public void readFromObject(Object obj) {
		...
		if (obj == null) {
			...
			decimalValue = (BigDecimal) OgnlUtils.convertValue(value, BigDecimal.class);
		}
