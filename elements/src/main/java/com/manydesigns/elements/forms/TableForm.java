...
public class TableForm implements Element {
	...
	public void toXhtml(@NotNull XhtmlBuffer xb) {
		...
		if (selectable) {
			...
			String js = "$(this).closest('table').find('td." + SELECTION_CELL_CLASS + " input').prop('checked', $(this).prop('checked'));";
	...
	public class Column {
		...
		public String getActualLabel() {
			boolean capitalize = ElementsProperties.getConfiguration().getBoolean(ElementsProperties.FIELDS_LABEL_CAPITALIZE);
			if (capitalize) {
