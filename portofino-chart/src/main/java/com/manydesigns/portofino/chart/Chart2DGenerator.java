...
public abstract class Chart2DGenerator extends AbstractChartGenerator {
	...
	public JFreeChart generate(ChartDefinition chartDefinition, Persistence persistence, Locale locale) {
		...
		if (plot.getOrientation() == PlotOrientation.VERTICAL) {
			CategoryLabelPosition pos = new CategoryLabelPosition(RectangleAnchor.TOP_LEFT, TextBlockAnchor.TOP_RIGHT, TextAnchor.TOP_RIGHT, -Math.PI / 4.0, CategoryLabelWidthType.CATEGORY, 100);
	...
	protected abstract JFreeChart createChart(ChartDefinition chartDefinition, CategoryDataset dataset, PlotOrientation plotOrientation);
}